...
const ContactSection = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "nirbhaysinghbest1@gmail.com",
      link: "mailto:nirbhaysinghbest1@gmail.com",
    },
    {
      icon: <Phone className="h-6 w-6 text-primary" />,
      title: "Phone",
      content: "+91 7004191931",
      link: "tel:+917004191931",
    },
    {
  ...
  return (
    <section id="contact" className="py-20 bg-background/50" ref={ref}>
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="bg-card rounded-lg shadow-lg p-6 card-hover h-full">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://www.instagram.com/someonespaceal/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-background p-3 rounded-full hover:bg-primary hover:text-primary-foreground transition-colors"
